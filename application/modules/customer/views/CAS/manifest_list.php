...
//            type: "POST",
//            data: ({txtNpwpPjt:'020640181428000',txtNoBarang:'CAS2017070502'}),
//            dataType: "JSON",
//            success: function(data)
//            {
//               //==================== Sucsess ========
...
<!--              <table class="uk-table uk-text-nowrap uk-container-oveflow">
 ...
 <!--    <?php echo $this->load->view('cas/CAS/tabs');?> -->
     ...
     <ul id="tab_detail" class="uk-tab" data-uk-tab="{connect:'#tabs_2'}">
       ...
       <li id="tab_discusstion" onclick="getdis();"><a href="#" class="uk-text-primary" ><i class="md-list-addon-icon material-icons md-24 uk-text-primary">question_answer</i> Discuss</a></li>
       <li id="tab_shipmentuser" onclick="get_shipmentuser();"><a href="#" class="uk-text-primary" ><i class="md-list-addon-icon material-icons md-24 uk-text-primary">supervisor_account</i> User</a></li>
