...
$(document).ready(function(){
    ...
    var zzz = '<?php echo $idhawb ; ?>';    
         list = $("#list_inquiry").DataTable({
                ...
                { "data": "Ket"},
                { "data": "StatusName"},
                { "data": "ShipperName","class":"uk-hidden"},
                { "data": "ConsigneeName","class":"uk-hidden"},
                { "data": "Description"},
                ]
         });
...
function back(){
    ...
    $('#listing').show();
    $('#tombol_nav').hide();
    $('#title').html('VIEW LISTING MANIFEST');
    clearTimeout(t);
    clearTimeout(intv_discusstion);
}
...
/*				$input=$("#eve").val();
      ...
      //  alert(cfie+'  '+ceve+' '+cval);
        ...
        if(cval==''){ 
            list.ajax.url( "<?php echo base_url(); ?>"+"cas/Cas/ManifestList/att/trias/"+date1+"/"+date2 ).load();
         }else{
...
function showticket(cidticket){
    ...
    function sinkronisasi(){
          ...
          url = '<?php echo base_url();?>cas/Cas/Sinkronisasi';
          var hid=$('#KeyHawb').val();
          $.ajax({
            url : url,
            type: "POST",
            ...
            {
               //==================== Sucsess ========
               swal("Success Sinkronisasi Data Tracking...!", "", "success");
               get_statustracking();
               getDesc();
            },
            error: function (jqXHR, textStatus, errorThrown)
        ...
        function get_statustracking(){
            ...
            $("#view_bc").load('<?php echo base_url()?>cas/Cas/get_barangkiriman'+'/'+hid);
        }
...
<!--              <table class="uk-table uk-text-nowrap uk-container-oveflow">
 ...
 <!--    <?php echo $this->load->view('cas/CAS/tabs');?> -->
     ...
     <ul id="tab_detail" class="uk-tab" data-uk-tab="{connect:'#tabs_2'}">
       ...
       <li id="tab_update" style="display: none;" onclick="getDesc();"><a href="#" class="uk-text-primary" ><i class="md-list-addon-icon material-icons md-24 uk-text-primary">mode_edit</i> Update</a></li>
       ...
       <li id="tab_discusstion" style="display: none;" onclick="getdis();"><a href="#" class="uk-text-primary" ><i class="md-list-addon-icon material-icons md-24 uk-text-primary">question_answer</i> Discussion</a></li>
...
<span id="v_listticket">
           <div class="uk-text-left" style="display: none;">
...
<span id="v_detail_ticket">                   
    <div id="shticket"></div>
           <div class="uk-text-left">
                ...
                <a style="display: none;"  onclick="UIkit.modal('#modal_comment').show();" class="md-btn md-btn-small md-btn-primary waves-effect waves-button ">
...
<!-- TAB 4 -->
       <li>
           <div  style="display: none;" class="uk-text-left">
...
<!-- end modal -->
       ...
       <li>
           <div style="display: none;" class="uk-text-left">
                <a onclick="UIkit.modal('#modal_updatestatus').show();" class="md-btn md-btn-small md-btn-primary waves-effect waves-button ">
              ...
              <form id="form_updatestatus" name="form_updatestatus">
                 <div class="uk-grid">  
                    ...
                    <div class="uk-width-medium-1-1">
                     ...
                     <div class="uk-form-row">
                       <label>Status Tracking</label>
                        <select id="ut_statusproses" name="ut_statusproses" class="ut_statusproses" required>
                              <option value=" ">...</option>
                        </select>
                     </div>
                     <div class="uk-form-row ">
