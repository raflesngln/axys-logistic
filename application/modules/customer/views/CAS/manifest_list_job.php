 ...
 //   alert(zzz);
     var zzz = '<?php echo $idhawb ; ?>';        
         list = $("#list_inquiry").DataTable({
                ...
                "order": [[ 2, "desc" ]],
                "ajax": {
                    "url": "<?php echo site_url('cas/Cas/ManifestList_myjob')?>"+"/rafles/",
                    "type": "POST",  
                },
                "columns": [
                { "data": "Mawb"},
...
/*				$input=$("#eve").val();
      ...
      //  alert(cfie+'  '+ceve+' '+cval);
        ...
        if(cval==''){ 
            list.ajax.url( "<?php echo base_url(); ?>"+"cas/Cas/ManifestList_myjob/att/trias/"+date1+"/"+date2 ).load();
         }else{
            list.ajax.url( "<?php echo base_url(); ?>"+"cas/Cas/ManifestList_myjob/"+zpt+"/"+cwhere+"/"+date1+"/"+date2 ).load();
         }    
    }
...
function cari2(){
		...
		if(input==''){
			...
			list.ajax.url("<?php echo base_url();?>cas/Cas/ManifestList_search_job/"+parameter).load();
		}
				//alert(kategori);
}
     ...
     <ul id="tabs_2" class="uk-switcher uk-margin">
        <li>
           <div class="uk-text-left">
                <a onclick="UIkit.modal('#modal_updatestatus').show();get_tlc();" class="md-btn md-btn-small md-btn-primary waves-effect waves-button ">
...
<span id="v_detail_ticket">                   
    <div id="shticket"></div>
           <div class="uk-text-left">
                ...
                <a  onclick="UIkit.modal('#modal_comment').show();get_tlc();" class="md-btn md-btn-small md-btn-primary waves-effect waves-button ">
