...
function addcoment(){
    ...
    $.ajax({
       ...
       data: ({idticket:cidticket,contents:ccontent,sts:csts,jam_awal:incall,jam_akhir:outcall,
               bycas:cas,byups:ups,outcome:outcome_result}),
       dataType: "JSON",
       success: function(data)
       {
           //==================== Sucsess ========
...
function updatestatusproses(){
          ...
          cproses = ut_statusproses.getValue();
        ...
        <div class="uk-grid" >
            ...
            <div class="uk-width-medium-1-4 uk-width-large-1-4">
             ...
             <div class="uk-width-medium-1-4 uk-width-large-1-4">
               ...
               <textarea name="val" class="md-input" id="val"></textarea>
             </div>
             <div class="uk-width-medium-1-4 uk-width-large-1-4">
               <a  onclick="cari();" class="md-btn md-btn-small md-btn-success waves-effect waves-button ">
               <i class="md-list-addon-icon material-icons md-24 md-color-white">search</i>Search2</a>
             </div>
        </div>
        <br />
        <br />
...
<span id="v_detail_ticket">                   
    ...
    <input  name="idmyticket" type="hidden" class="md-input" id="idmyticket" > 
        <div style="display: none;" style="margin-bottom: 5px;" class="parsley-row">
        </div>
        ...
        <div class="uk-modal" id="modal_comment">
            <div class="uk-modal-dialog">
              ...
              <div class="uk-modal-footer uk-text-right">
                ...
                <button type="button" class="md-btn md-btn-flat md-btn-flat-primary" onclick="addcoment()">Yes</button>
              </div>
            </div>
        </div>
        ...
        <form id="form_create_ticket" >
            <div class="uk-modal-dialog">
              ...
              <div class="uk-modal-footer uk-text-right">
                ...
                <button type="button" onclick="addticket()" class="md-btn md-btn-flat md-btn-flat-primary" tabindex="10">Yes</button>
              </div>
            </div>
         </form>
        </div>
