...
function print_(ctk=''){
    ...
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+track+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_typeclearance_new')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+track+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_typeclearance_new')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+track+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_typeclearance_new')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT TYPE CLEARANCE PMK 182</h3>
            </div>
        ...
        <div class="uk-grid" >
            <div class="uk-width-large-1-3" id="Sts">
                <div class="uk-form-row parsley-row">
                    <label for="">Type Clearance PMK 182<span class="req"> *</span></label>
