...
function print_(ctk=''){
    ...
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_history_type')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_history_type')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_history_type')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT PERUBAHAN TYPE CLEARANCE</h3>
            </div>
          ...
          <div class="uk-grid" >
            <div  class="uk-width-large-1-4 uk-width-medium-1-3">
                <div class="uk-input-group">
                    ...
                    <label for="uk_dp_start">Start Date Update</label>
            ...
            <div  class="uk-width-large-1-4 uk-width-medium-1-3">
                <div class="uk-input-group">
                   <span class="uk-input-group-addon"><i class="uk-input-group-icon uk-icon-calendar"></i></span>
                   <label for="uk_dp_end">End Date Update</label>
