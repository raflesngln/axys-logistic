    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT TRACKING WITH OPERAND</h3>
            </div>
...
<!-- LISTING HISTORY IMPORT -->                    
        ...
        <div class="uk-grid" >
             <div class="uk-width-medium-1-3 uk-width-large-1-3 "> 
                 ...
                 <span class="icheck-inline">
                      <input type="radio" name="radio_demo_inline" id="radio_demo_inline_3" onchange="perval(3);"/>
                      <label for="radio_demo_inline_3" class="inline-label">Not Contains</label>
                 </span>
             </div>
        </div>
        <div class="uk-grid" >
