...
//      }
    ...
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2,"<?php echo site_url('cas/Ccas_rpt/rpt_ticket_myuser')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2,"<?php echo site_url('cas/Ccas_rpt/rpt_ticket_myuser')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2,"<?php echo site_url('cas/Ccas_rpt/rpt_ticket_myuser')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">MY REPORT TICKET</h3>
            </div>
