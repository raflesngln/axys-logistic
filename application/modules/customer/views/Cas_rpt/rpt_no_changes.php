...
//==========================================
       $.ajax({
           url: '<?php echo base_url();?>cas/Ccas_rpt/cmbTypeClearance',
           dataType: "json",
...
//=======================================
       $.ajax({
           url: '<?php echo base_url();?>cas/Ccas_rpt/cmbStatusProses',
           dataType: "json",
           success: function(data){
            console.log(data);
...
function print_(ctk=''){
    ...
    var tgl1    =$('#countdays').val();
    var tgl2    ='1';//$('#uk_dp_end').val();
    
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_noprogress_status')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_noprogress_status')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_noprogress_status')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">HOUSE REPORT NO SUBMIT CHANGES</h3>
            </div>
...
<div  class="uk-width-medium-1-1">&nbsp;</div>                
          <div class="uk-grid" >
            <div class="uk-width-large-1-3" id="Sts">
                <div class="uk-form-row parsley-row">
                  <h4>Not Process in</h4></label>
                    <select class="md-input" id="countdays" name="countdays" required >
                      <?php 
					   for($a=2;$a<=15;$a++){
					   ?>
        ...
        <div class="uk-grid" >
          ...
          <div class="uk-grid" >
            <div class="uk-width-medium-3-10" id="Sts">
             ...
             <div class="uk-width-medium-6-10">
                    <label for="">Status Tracking<span class="req"> *</span></label>
