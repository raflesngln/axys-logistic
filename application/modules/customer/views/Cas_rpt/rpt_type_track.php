...
function print_(ctk=''){
    ...
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT TYPE CLEARANCE AND STATUS TRACKING</h3>
            </div>
