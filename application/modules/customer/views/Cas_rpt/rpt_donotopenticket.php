...
function print_(ctk=''){
    ...
    switch (ctk) {
    case '1':
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_donotopenticket')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_donotopenticket')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_donotopenticket')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT TICKET NOT AVAILABLE</h3>
            </div>
