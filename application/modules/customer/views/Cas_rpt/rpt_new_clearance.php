...
function print_(ctk=''){
    ...
    case '1':
        ...
        cetakPrev('4|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track_new')?>","#preview_his"); 
        UIkit.switcher('#h_tab').show(1);
        break;
    case '2':
    //alert(ctk);
        cetakTri('1|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track_new')?>");     
        break;
    case '3':
    //alert(ctk);
        cetakTri('2|'+tgl1+'|'+tgl2+'|'+track+'|'+ctype+'|'+$per,"<?php echo site_url('cas/Ccas_rpt/rpt_type_track_new')?>"); 
        break;
    }
}
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">REPORT TYPE CLEARANCE AND STATUS TRACKING ( New Type Clearance)</h3>
            </div>
                <div class="md-card-content">
                    <ul id="h_tab" class="uk-tab" data-uk-tab="{connect:'#tabs_1'}">
                    <li><a href="#" ><i class="md-list-addon-icon material-icons md-24">list</i>
                    FIlter Periode
                    </a></li>
