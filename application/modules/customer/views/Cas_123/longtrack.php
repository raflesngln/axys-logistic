...
$(document).ready(function(){
    ...
    var
      data = [
        {ship_no: 'Ship No',rectype : 'rec_type',weight : 'p_wgt',weigthunit : 'p_wgt_u',tracking_no : 'track_e',pkgs : 'pkgs'}];
        
      data1 = [
        {ship_no: '', rectype: '',weight : '',weigthunit : '',tracking_no : '',pkgs : ''}];        
...
//  $('#button_import').hide();  
  ...
  var rmark = $('#remark').val();
    ...
    AddItems('Cek Data...!','','0');
    $.ajax({
        url: "<?php echo base_url(); ?>/Cas/Cas/cek_data_manifestlongtrack",
        data: {
            "data": mydata
            			    ...
            			    var cek=true;
                             ...
                             if(cek){
                              AddItems('Please wait, Proses Import Data...!','','0');   
                                $.ajax({
                                    type: "POST",
                    				url: '<?php echo base_url(); ?>Cas/Cas/insert_data_manifestlongtrack',
                                    data:{
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">IMPORT DATA MANIFEST LONGTRACK</h3>
            </div>
