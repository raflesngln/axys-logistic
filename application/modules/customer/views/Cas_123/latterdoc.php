...
//  $('#button_import').hide();  
  ...
  var rmark = $('#remark').val();
    ...
    AddItems('Cek Data...!','','0');
    $.ajax({
        url: "<?php echo base_url(); ?>/Cas/Cas/cek_data_manifestletterdoc",
        data: {
            "data": mydata
            			    ...
            			    var cek=true;
                             ...
                             if(cek){
                              AddItems('Please wait, Proses Import Data...!','','0');   
                                $.ajax({
                                    type: "POST",
                    				url: '<?php echo base_url(); ?>Cas/Cas/insert_data_manifestletterdoc',
                                    data:{
    ...
    <div class="uk-width-medium-1-1">
        <div class="md-card" id="cont">
            <div class="md-card-toolbar" style="height: 55px;">
                ...
                <h3 id="title" class="md-card-toolbar-heading-text">IMPORT DATA MANIFEST LETTER DOC</h3>
            </div>
