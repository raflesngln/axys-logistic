$(function() {
    altair_datatables.dt_default(), altair_datatables.dt_scroll(), altair_datatables.dt_individual_search(), altair_datatables.dt_colVis(), altair_datatables.dt_tableTools()
}), altair_datatables = {
    dt_default: function() {
        var t = $("#dt_default");
    ...
    dt_tableTools: function() {
        ...
        if (t.length) {
            ...
            $(e.fnContainer()).insertBefore(t.closest(".dt-uikit").find(".dt-uikit-header")), $body.on("click", function(t) {
